...
<body>
	<form action="DiaryWriteC" method="post" name="diaryWriteForm">
			...
			<tr>
				<td id="diaryWritePageArea" align="center" colspan="2">
					<table id="diaryWriteTbl" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td class="wtd">제목</td>
							<td class="wtd2"><input name="d_title" size="90%" id="writeInput"></td>
						</tr>
						<tr>
							<td class="wtdTextTd">내용</td>
							<td><textarea name="d_txt" id="writeTextArea"></textarea></td>
						</tr>
					</table>
			<tr>
