...
<body>
	<form action="BoardWriteC" name="boardWriteForm"
			...
			<c:choose>
				<c:when test="${sessionScope.loginMember != null }">
					<tr>
						...
						<td id="boardWriteTxtTd" align="center"><textarea
								name="b_txt" autofocus="autofocus" id="boardWriteTxtTextarea"
								placeholder="What's your Q?" maxlength="200"></textarea></td>
						<td id="boardWriteBtnTd"><input id="boardWriteBtn" type="submit" value="작성">
						</td>
					</tr>
				</c:when>
				<c:otherwise>
					...
					<table id="boardList" cellpadding="0" cellspacing="0">
						<tr>
							<td rowspan="5" class="boardImgTd" valign="top" align="center">
								<img onclick="searchBoard(img/'${b.b_id}');" class="boardImg"
								src="img/${b.m_img }">
							</td>
						...
						<tr>
							...
							<fmt:formatDate	value="${b.b_date }" type="both" dateStyle="long"
									timeStyle="short" /> &nbsp;&nbsp;</td>
						</tr>
						<tr>
